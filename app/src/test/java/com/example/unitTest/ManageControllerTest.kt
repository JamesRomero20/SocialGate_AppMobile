...
class ManageControllerTest {
     ...
     */
    @Test
    fun `PU - Validar que un usuario no pueda actualizar sus credenciales si son pertenecientes a otro usuario`() {
    ...
    @Test
    fun `PU - updateUserData con email duplicado llama a showEmailTakenError`() {
    ...
    @Test
    fun `PU - updateUserData con contraseña duplicada muestra error`() {
    ...
    @Test
    fun `PU - updateUserData con datos válidos llama a showUpdateSuccess`() {
     ...
     */
    @Test
    fun `PU - logout llama a deleteSchedulesForUser y navigateToLogin`() {
        controller.logout()
